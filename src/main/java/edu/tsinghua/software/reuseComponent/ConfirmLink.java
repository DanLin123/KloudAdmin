...
/**
 * ConfirmLink compoent， show confirm mesage when click link 
 * @author 林丹
 * */
abstract public class ConfirmLink extends Link {
    ...
    public ConfirmLink(String id, String msg, String operation) {
        super(id);
        add(new JavascriptEventConfirmation("onclick", msg+operation));
   }
